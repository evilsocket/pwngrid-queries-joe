...
Some of these are running on https://pwnagotchi.ai/stats/
...
#### Request
    ...
    curl http://127.0.0.1:8080/api/v1/query/top_players/view
...
```json
{
  "created_at": "2019-11-09T17:47:54.266089557+01:00",
  "updated_at": "2019-11-09T17:47:54.266168973+01:00",
  "name": "top_players",
  "cache": {
    "type": 1,
    "keys": [
...
#### Request
    ...
    curl http://127.0.0.1:8080/api/v1/query/top_players.json
...
#### Request
    ...
    curl http://127.0.0.1:8080/api/v1/query/top_players/explain?limit=25
...
#### Request
    ...
    curl http://127.0.0.1:8080/api/v1/query/top_players/bars.png?limit=25
...
#### Request
    ...
    curl http://127.0.0.1:8080/api/v1/query/units_per_day/view
...
```json
{
  "created_at": "2019-11-09T17:47:23.34582932+01:00",
  "updated_at": "2019-11-09T17:47:23.345980576+01:00",
  "name": "units_per_day",
  "cache": {
    "type": 1,
    "keys": [
...
#### Request
    ...
    curl http://127.0.0.1:8080/api/v1/query/units_per_day.json
...
#### Request
    ...
    curl http://127.0.0.1:8080/api/v1/query/units_per_day/explain?days=30
...
#### Request
    ...
    curl http://127.0.0.1:8080/api/v1/query/units_per_day/chart.png?days=30
...
#### Request
    ...
    curl http://127.0.0.1:8080/api/v1/query/aps_per_day/view
...
```json
{
  "created_at": "2019-11-09T17:47:29.525464025+01:00",
  "updated_at": "2019-11-09T17:47:29.525606627+01:00",
  "name": "aps_per_day",
  "cache": {
    "type": 1,
    "keys": [
...
#### Request
    ...
    curl http://127.0.0.1:8080/api/v1/query/aps_per_day.json
...
#### Request
    ...
    curl http://127.0.0.1:8080/api/v1/query/aps_per_day/explain?days=30
...
#### Request
    ...
    curl http://127.0.0.1:8080/api/v1/query/aps_per_day/chart.png?days=30
